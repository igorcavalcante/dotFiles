...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({}, "XF86AudioPrev", function() awful.util.spawn("playerctl next", false) end),
  awful.key({}, "XF86AudioNext", function() awful.util.spawn("playerctl previous", false) end),
  ...
  awful.key({ modkey }, "b", function() awful.util.spawn("betterlockscreen -l") end),

  awful.key({ modkey }, ",", function() awful.util.spawn("setxkbmap -layout us") end),
  awful.key({ modkey }, ".", function() awful.util.spawn("setxkbmap -layout us -variant intl") end),

  -- naughty
  awful.key({ modkey }, "d", function() naughty.destroy_all_notifications() end,
    { description = "descartar todas as notificações", group = "notificações" })
...
awful.keyboard.append_global_keybindings({
  ...
  awful.key({ modkey, }, "Tab", function() awful.screen.focus_relative(1) end,
    { description = "alternate screeens", group = "screen" }),
